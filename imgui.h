...
namespace ImGui
{
    ...
    IMGUI_API ImDrawList*   GetHudDrawList(); 
...
enum ImGuiCol_
{
    ...
    ImGuiCol_WindowSelected,    
    ImGuiCol_WindowSelectedPending,              
...
struct ImGuiIO
{
    ...
    ImVec2      MouseClickedPosScreen[5];           // [PR] Position at time of clicking
